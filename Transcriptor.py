...
def main(): 
    ...
    if audio_file is not None:
        ...
        chunk_size = 40 * 60000 if file_size_mb > 25 else (40 * 60000 if len(AudioSegment.from_file(temp_audio_path)) > (40 * 60000) else len(AudioSegment.from_file(temp_audio_path)))
